...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		chartingText.setFormat(Paths.font('komika.ttf'), 32);
	...
	function regenMenu():Void {
		...
		for (i in 0...menuItems.length) {
			...
			if(menuItems[i] == 'Skip Time')
			{
				...
				skipTimeText.setFormat(Paths.font("komika.ttf"), 64, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
