...
class PlayState extends MusicBeatState
{
	...
	public var creditsPopup:CreditsPopup = null;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'convention': new states.stages.ConventionStage();
			case 'elevator': new states.stages.ElevatorStage();
			case 'thepee': new states.stages.PeeStage();
			case 'sigma': new states.stages.SigmaStage();
		}
		...
		timeTxt.setFormat(Paths.font('komika.ttf'), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		creditsPopup = new CreditsPopup(5, 50, SONG.song ?? 'Unknown');
		creditsPopup.scrollFactor.set();
		creditsPopup.visible = false;
		uiGroup.add(creditsPopup);
		...
		scoreTxt.setFormat(Paths.font('komika.ttf'), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font('komika.ttf'), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
